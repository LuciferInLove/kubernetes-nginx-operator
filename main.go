...
import (
	...
	"github.com/LuciferInLove/kubernetes-nginx-operator/controllers"
...
func init() {
	...
	utilruntime.Must(nginxv1beta1.AddToScheme(scheme))
	//+kubebuilder:scaffold:scheme
	cert.AddToScheme(scheme)
}
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "42913a02.custom-nginx.org",
	})
	if err != nil {
